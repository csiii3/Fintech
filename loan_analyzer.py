...
print(f"Total of vaule loans {sum_of_loans}")


# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = 2750/5
...
print(f"Future Value {x} , Remaining Months {y}")
...
print(f"The present value of New loan is: {present_value}\n")
...
for p in loans:
    if p["loan_price"] <= 500:
        inexpensive_loans.append(p)
print("\nInexpensive Loans:")
for p in inexpensive_loans:
    print(p)
